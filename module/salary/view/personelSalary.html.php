<td>
		...
		<table>
	        <thead>
		        <tr>
		            <th colspan="14" style="font-size: 16px;"><?php echo $lang->salary->personMonthDetail;?></th>
	        ...
	        <tbody>
	        <?php $i=0;?>
	        <?php foreach ($monthHours as $hours):?>
	        <?php $i++;?>
	        <tr class='a-center' style="height: 35px;">
	          <td><?php echo $i;?></td>
	          <td><?php common::printLink('salary', 'monthly', 'typeID=2&finishedDate='.$hours->year,$hours->realname);?></td>
	          <td><?php echo $hours->standsalary;?></td>
	          <td><?php echo $hours->standsalary*0.6;?></td>
	          <td><?php echo $hours->personnelCoeff;?></td>
	          <td><?php echo $hours->count;?></td>
	          <td><?php echo $hours->deptCoeff;?></td>
