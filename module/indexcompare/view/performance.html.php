	...
	<table width="100%" class="cont-lt1">
		<tr valign="top">
		  <td width="12%" style="padding-right: 10px;" class="side">
			  <div class="box-title"><?php echo $lang->indexcompare->titPerformance;?></div>
			  <div class="box-content">
				  <ul id="report-list">
				  	<li>
				  		<?php echo html::a($this->createLink('indexcompare', 'performance'), $lang->indexcompare->proPerformance);?>
				  	</li>
				  	<li>
				  		<?php echo html::a($this->createLink('indexcompare', 'perPerformance'), $lang->indexcompare->perPerformance);?>
				  	</li>
				  </ul>
			  </div>
		  </td>
		  <td>
				<!-- <div class="week-title"><?php echo $lang->indexcompare->titPerformance;?></div>-->
			<form method="post">
  		   ...
  		   <table class="table-1 fixed colored datatable border-sep" id="product">
  			  <thead>
  			  	<tr class="colhead">
  			  		...
  			  		<th><?php echo $lang->indexcompare->proScore;?></th>
  			  		<th><?php echo $lang->indexcompare->proHighestScore;?></th>
  			  		<th><?php echo $lang->indexcompare->proPerformance;?></th>
