  		   ...
  		   <table class="table-1 colored datatable border-sep" id="product">
  		    <caption><div align="center">编辑项目组信息</div></caption>
  			  <thead>
				  ...
				  <tr>    
				      <th>组长</th><td><?php echo html::select('leader', $nowLeaders, '', "class='select-1'");?></td>
				  </tr>
				  <tr>    
				      <th width="35%">技术经理</th>
				      <td>
				      	<?php 
				      	echo html::select('son_techmanager[]', $nowManagers, str_replace(' ', '', $preManagersStr), 'class="text-1" multiple style="vertical-align:middle"');
