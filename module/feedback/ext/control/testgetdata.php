...
// include '../../../../../zendXirangcsm/module/request/control.php';

/* 用来登录的地址，用户名和密码。*/
$zentaoRoot  = "http://127.0.0.1:88/zendXirangcsm/www/admin.php/";  // 请根据实际的情况进行修改。
$account     = "beanGou";
$password    = "root";
...
//     $requestTestAPI = $zentaoRoot . "request-";
